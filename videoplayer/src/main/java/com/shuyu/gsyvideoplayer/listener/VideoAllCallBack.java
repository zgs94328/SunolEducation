...
public interface VideoAllCallBack {
    int ErrorTypeNet = 1; //播放出错，因为网络原因
    int ErrorTypeUnknow = 2;  //播放出错，原因未知
    ...
    // errorType参数add by TangJian 2018-08-29
    void onPlayError(String url, int errorType, Object... objects);
