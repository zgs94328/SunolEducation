...
//        String cookieTemp = cookie.toString();
//        CookieUtil.setCookie(cookieTemp, AppManager.getAppManager().currentActivity());
//        DMLog.e(this.getClass().getSimpleName(), "cookieTemp = " + cookieTemp);
