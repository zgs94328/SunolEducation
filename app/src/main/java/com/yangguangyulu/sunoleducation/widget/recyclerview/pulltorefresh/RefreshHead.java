package com.yangguangyulu.sunoleducation.widget.recyclerview.pulltorefresh;
...
public class RefreshHead extends LinearLayout {
    ...
    public RefreshHead(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textTip = refreshContentView.findViewById(R.id.textTip);
        textLastRefreshTime = refreshContentView.findViewById(R.id.textLastRefreshTime);
        imageArrow = refreshContentView.findViewById(R.id.imageArrow);
        imageRefreshing = refreshContentView.findViewById(R.id.imageRefreshing);
        //一开始设置高度为0 不显示刷新布局
