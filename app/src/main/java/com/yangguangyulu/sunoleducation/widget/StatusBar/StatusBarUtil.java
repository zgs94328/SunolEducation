package com.yangguangyulu.sunoleducation.widget.StatusBar;
...
//        } else
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    private static void setColorForSwipeBack(Activity activity, @ColorInt int color, int statusBarAlpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
...
//        }
    ...
    private static int calculateStatusColor(int color, int alpha) {
        ...
        long result = 0xff << 24 | red << 16 | green << 8 | blue;
        return (int) result;
    }
    ...
    public static void setStatusTextColor(boolean useDart, Activity activity) {
        if (isFlyme()) {
            ...
            if (useDart) {
                //配合values-v23文件夹下styles.xml，设置属性<item name="android:windowLightStatusBar">true</item>
